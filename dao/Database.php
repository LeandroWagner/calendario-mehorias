...
class Database {
    ...
    public function __construct ($dbname = 'melhorias', $host = 'calendario-melhorias_database_1', $port = '5432', $user = 'postgres', $pass = 'root') 
    {
    ...
    //------------------------------------------------------------------
    //Verifica se pode ser realizada a alteração.
    public function identificaTarefa($id){
         
         $dbst = $this->db->prepare(" SELECT tarefa FROM ". static::TABLE ." WHERE id = :id ");
         $dbst->bindValue(':id', $id, \PDO::PARAM_STR);
     ...
     //------------------------------------------------------------------
    //Busca area .
    public function buscaArea($descricao){
         
        $dbst = $this->db->prepare(" SELECT area FROM ". static::TABLE ." WHERE descricao = :descricao ");
        $dbst->bindValue(':descricao', $descricao, \PDO::PARAM_STR);
    ...
    //------------------------------------------------------------------
    //Grava area .
    public function gravaArea($descricao){
